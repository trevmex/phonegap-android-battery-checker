...
;var scooj = require('scooj'); var StackTrace = require('./StackTrace'); if (typeof StackTrace != 'function') throw Error('module ./StackTrace did not export a class');
...
;var scooj = require('scooj'); var Ex = require('./Ex'); if (typeof Ex != 'function') throw Error('module ./Ex did not export a class');
var IDLTools = require('./IDLTools'); if (typeof IDLTools != 'function') throw Error('module ./IDLTools did not export a class');
var StackTrace = require('./StackTrace'); if (typeof StackTrace != 'function') throw Error('module ./StackTrace did not export a class');
...
;var scooj = require('scooj'); var Ex = require('./Ex'); if (typeof Ex != 'function') throw Error('module ./Ex did not export a class');
var Callback = require('./Callback'); if (typeof Callback != 'function') throw Error('module ./Callback did not export a class');
...
;var scooj = require('scooj'); var Weinre = require('./Weinre'); if (typeof Weinre != 'function') throw Error('module ./Weinre did not export a class');
var WebSocketXhr = require('./WebSocketXhr'); if (typeof WebSocketXhr != 'function') throw Error('module ./WebSocketXhr did not export a class');
var IDLTools = require('./IDLTools'); if (typeof IDLTools != 'function') throw Error('module ./IDLTools did not export a class');
var Binding = require('./Binding'); if (typeof Binding != 'function') throw Error('module ./Binding did not export a class');
var Ex = require('./Ex'); if (typeof Ex != 'function') throw Error('module ./Ex did not export a class');
var MessageDispatcher = scooj.defClass(module, function MessageDispatcher(url) {
this._url        = url
this.error       = null
this._opening    = false
this._opened     = false
...
}); scooj.defMethod(module, function _handleOpen() {
this._opening = false
this._opened  = true
if (Verbose) {
...
;var scooj = require('scooj'); var Ex = require('./Ex'); if (typeof Ex != 'function') throw Error('module ./Ex did not export a class');
var Weinre = require('./Weinre'); if (typeof Weinre != 'function') throw Error('module ./Weinre did not export a class');
var EventListeners = require('./EventListeners'); if (typeof EventListeners != 'function') throw Error('module ./EventListeners did not export a class');
var Native = require('./Native'); if (typeof Native != 'function') throw Error('module ./Native did not export a class');
var WebSocketXhr = scooj.defClass(module, function WebSocketXhr(url) {
this.initialize(url)
}); 
...
scooj.defMethod(module, function initialize(url) {
...
var CallbackIndex = 1
var ConnectorId   = "???"
scooj.defStaticMethod(module, function setConnectorId(connectorId) {
...
;var scooj = require('scooj'); var Weinre = require('../common/Weinre'); if (typeof Weinre != 'function') throw Error('module ../common/Weinre did not export a class');
var Timeline = require('../target/Timeline'); if (typeof Timeline != 'function') throw Error('module ../target/Timeline did not export a class');
...
//==================================================
require("weinre/common/Weinre").addCSSProperties([
"-webkit-animation", 
...
;var scooj = require('scooj'); var Weinre = require('../common/Weinre'); if (typeof Weinre != 'function') throw Error('module ../common/Weinre did not export a class');
var Native = require('../common/Native'); if (typeof Native != 'function') throw Error('module ../common/Native did not export a class');
...
;var scooj = require('scooj'); var Weinre = require('../common/Weinre'); if (typeof Weinre != 'function') throw Error('module ../common/Weinre did not export a class');
var Callback = require('../common/Callback'); if (typeof Callback != 'function') throw Error('module ../common/Callback did not export a class');
var Console = require('./Console'); if (typeof Console != 'function') throw Error('module ./Console did not export a class');
var WeinreTargetEventsImpl = scooj.defClass(module, function WeinreTargetEventsImpl() {
}); scooj.defMethod(module, function connectionCreated( clientId,  targetId) {
...
}); scooj.defMethod(module, function connectionDestroyed( clientId,  targetId) {
...
;var scooj = require('scooj'); var Weinre = require('../common/Weinre'); if (typeof Weinre != 'function') throw Error('module ../common/Weinre did not export a class');
var IDGenerator = require('../common/IDGenerator'); if (typeof IDGenerator != 'function') throw Error('module ../common/IDGenerator did not export a class');
...
;var scooj = require('scooj'); var IDGenerator = require('../common/IDGenerator'); if (typeof IDGenerator != 'function') throw Error('module ../common/IDGenerator did not export a class');
var Weinre = require('../common/Weinre'); if (typeof Weinre != 'function') throw Error('module ../common/Weinre did not export a class');
...
;var scooj = require('scooj'); var Native = require('../common/Native'); if (typeof Native != 'function') throw Error('module ../common/Native did not export a class');
var Ex = require('../common/Ex'); if (typeof Ex != 'function') throw Error('module ../common/Ex did not export a class');
var Binding = require('../common/Binding'); if (typeof Binding != 'function') throw Error('module ../common/Binding did not export a class');
var Callback = require('../common/Callback'); if (typeof Callback != 'function') throw Error('module ../common/Callback did not export a class');
var MessageDispatcher = require('../common/MessageDispatcher'); if (typeof MessageDispatcher != 'function') throw Error('module ../common/MessageDispatcher did not export a class');
var Weinre = require('../common/Weinre'); if (typeof Weinre != 'function') throw Error('module ../common/Weinre did not export a class');
var CheckForProblems = require('./CheckForProblems'); if (typeof CheckForProblems != 'function') throw Error('module ./CheckForProblems did not export a class');
var NodeStore = require('./NodeStore'); if (typeof NodeStore != 'function') throw Error('module ./NodeStore did not export a class');
var CSSStore = require('./CSSStore'); if (typeof CSSStore != 'function') throw Error('module ./CSSStore did not export a class');
var ElementHighlighter = require('./ElementHighlighter'); if (typeof ElementHighlighter != 'function') throw Error('module ./ElementHighlighter did not export a class');
var InjectedScriptHostImpl = require('./InjectedScriptHostImpl'); if (typeof InjectedScriptHostImpl != 'function') throw Error('module ./InjectedScriptHostImpl did not export a class');
var WeinreTargetEventsImpl = require('./WeinreTargetEventsImpl'); if (typeof WeinreTargetEventsImpl != 'function') throw Error('module ./WeinreTargetEventsImpl did not export a class');
var WiConsoleImpl = require('./WiConsoleImpl'); if (typeof WiConsoleImpl != 'function') throw Error('module ./WiConsoleImpl did not export a class');
var WiCSSImpl = require('./WiCSSImpl'); if (typeof WiCSSImpl != 'function') throw Error('module ./WiCSSImpl did not export a class');
var WiDatabaseImpl = require('./WiDatabaseImpl'); if (typeof WiDatabaseImpl != 'function') throw Error('module ./WiDatabaseImpl did not export a class');
var WiDOMImpl = require('./WiDOMImpl'); if (typeof WiDOMImpl != 'function') throw Error('module ./WiDOMImpl did not export a class');
var WiDOMStorageImpl = require('./WiDOMStorageImpl'); if (typeof WiDOMStorageImpl != 'function') throw Error('module ./WiDOMStorageImpl did not export a class');
var WiInspectorImpl = require('./WiInspectorImpl'); if (typeof WiInspectorImpl != 'function') throw Error('module ./WiInspectorImpl did not export a class');
var WiRuntimeImpl = require('./WiRuntimeImpl'); if (typeof WiRuntimeImpl != 'function') throw Error('module ./WiRuntimeImpl did not export a class');
...
}); scooj.defMethod(module, function cb_registerTarget(targetId) {
...
;var scooj = require('scooj'); var Binding = require('../common/Binding'); if (typeof Binding != 'function') throw Error('module ../common/Binding did not export a class');
var Weinre = require('../common/Weinre'); if (typeof Weinre != 'function') throw Error('module ../common/Weinre did not export a class');
...
;var scooj = require('scooj'); var Ex = require('../common/Ex'); if (typeof Ex != 'function') throw Error('module ../common/Ex did not export a class');
var Weinre = require('../common/Weinre'); if (typeof Weinre != 'function') throw Error('module ../common/Weinre did not export a class');
var IDGenerator = require('../common/IDGenerator'); if (typeof IDGenerator != 'function') throw Error('module ../common/IDGenerator did not export a class');
var StackTrace = require('../common/StackTrace'); if (typeof StackTrace != 'function') throw Error('module ../common/StackTrace did not export a class');
var Native = require('../common/Native'); if (typeof Native != 'function') throw Error('module ../common/Native did not export a class');
